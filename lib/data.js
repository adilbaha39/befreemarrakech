...
//
// VEHICLES now lives in /data/vehicles.json instead of being hardcoded
// here, so the admin dashboard can read/write it through the GitHub API
...
export const VEHICLES = vehiclesJson;
